        ...
        >
          ...
          <div className="hidden md:flex">
            <Link href="/auth/login">
              <button
                type="button"
                className="relative overflow-hidden text-white bg-gradient-to-r from-green-500 to-blue-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-2 transition-transform duration-500 ease-in-out group cursor-pointer"
              >
